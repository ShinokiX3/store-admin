...
const Product = styled.div<{ isWrapp: boolean }>`
	display: grid;
	align-items: center;
	grid-template-columns: 0.25fr 0.2fr 0.5fr 1fr 0.2fr 0.3fr 0.4fr 0.4fr;
	margin-bottom: 15px;
	background-color: #f0f1f2;
	padding: 5px;
	border-radius: 0.2rem;
	white-space: ${(props) => (props.isWrapp ? 'nowrap' : 'inherit')};
...
const Products = () => {
	...
	// 					<p>Quantity in stock: {product.inStockQuantity}</p>
	// 				</Product>
	// 			))}
	// 		</div>
	// 	</Wrapper>
